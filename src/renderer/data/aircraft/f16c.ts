...
const CL: number[][] = [
  ...
  [ 0.90,  0.92,  0.95,  0.96,  0.88,  0.78,  0.68], // 10°
  [ 1.20,  1.22,  1.25,  1.22,  1.10,  0.98,  0.85], // 15°
  [ 1.30,  1.28,  1.30,  1.25,  1.12,  1.00,  0.88], // 20°
...
const CD: number[][] = [
  ...
  [0.052, 0.054, 0.056, 0.068, 0.080, 0.072, 0.065],
  [0.100, 0.102, 0.105, 0.120, 0.135, 0.122, 0.110],
  [0.180, 0.182, 0.185, 0.210, 0.230, 0.210, 0.190],
...
export const F16C: AircraftSpec = {
  ...
  controlEffectiveness: {
    ...
    CLde: [0.085, 0.082, 0.075, 0.065, 0.050],
    CMde: [-0.030, -0.028, -0.025, -0.020, -0.015],
    CLda: [0.040, 0.038, 0.030, 0.022, 0.015],
    CNdr: [-0.025, -0.024, -0.020, -0.016, -0.012],
  },
  engine: {
    maxThrustDryN: 76300,
