...
const CL: number[][] = [
  ...
  [ 0.92, 0.94, 0.97, 0.98, 0.90, 0.80, 0.70],
  [ 1.25, 1.27, 1.30, 1.27, 1.14, 1.01, 0.88],
  [ 1.35, 1.33, 1.35, 1.30, 1.17, 1.04, 0.91],
...
const CD: number[][] = [
  ...
  [0.052,0.054,0.056,0.068,0.080,0.073,0.065],
  [0.100,0.102,0.105,0.120,0.135,0.123,0.110],
  [0.180,0.182,0.185,0.210,0.232,0.212,0.192],
