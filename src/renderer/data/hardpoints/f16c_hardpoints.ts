...
export const F16C_HARDPOINTS: HardpointDef[] = [
  ...
  { id: 'W2',  posBodyM: [-2.0, 3.2, 0.3],  compatibleTypes: ['IR_MISSILE', 'ARH_MISSILE'],          maxStoreKg: 250  },
  { id: 'W3',  posBodyM: [-1.0, 3.0, 0.3],  compatibleTypes: ['ARH_MISSILE', 'FUEL_TANK'],           maxStoreKg: 800  },
  { id: 'CL',  posBodyM: [0,    0,   0.4],  compatibleTypes: ['ARH_MISSILE', 'FUEL_TANK'],           maxStoreKg: 1000 },
  { id: 'E3',  posBodyM: [1.0,  -3.0, 0.3], compatibleTypes: ['ARH_MISSILE', 'FUEL_TANK'],           maxStoreKg: 800  },
  { id: 'E2',  posBodyM: [2.0,  -3.2, 0.3], compatibleTypes: ['IR_MISSILE', 'ARH_MISSILE'],          maxStoreKg: 250  },
